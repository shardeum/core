...
import { serializeSpreadAppliedVoteHashReq, deserializeSpreadAppliedVoteHashReq, SpreadAppliedVoteHashReq, } from '../../../../src/types/SpreadAppliedVoteHashReq';
...
describe('SpreadAppliedVoteHashReq Tests', () => {
    ...
    describe('deserializeSpreadAppliedVoteHashReq', () => {
        ...
        it('should throw error on unsupported version', () => {
            stream.writeUInt8(cSpreadAppliedVoteHashReqVersion + 1);
