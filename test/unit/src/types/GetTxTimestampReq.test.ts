import { cGetTxTimestampReqVersion, deserializeGetTxTimestampReq, getTxTimestampReq, serializeGetTxTimestampReq, } from '../../../../src/types/GetTxTimestampReq';
...
describe('GetTxTimestampReq Tests', () => {
    ...
    describe('deserializeGetTxTimestampReq', () => {
        ...
        it('should throw error on unsupported version', () => {
            stream.writeUInt8(cGetTxTimestampReqVersion + 1);
