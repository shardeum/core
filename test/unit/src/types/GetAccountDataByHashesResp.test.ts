...
import { GetAccountDataByHashesResp, cGetAccountDataByHashesRespVersion, deserializeGetAccountDataByHashesResp, serializeGetAccountDataByHashesResp, } from '../../../../src/types/GetAccountDataByHashesResp';
...
describe('GetAccountDataByHashesResp Tests', () => {
    ...
    describe('Serialization Tests', () => {
        ...
        test('Throw Error on Version Mismatch', () => {
            ...
            expect(() => deserializeGetAccountDataByHashesResp(alteredStream)).toThrow(`GetAccountDataByHashesRespDeserializer expected version ${cGetAccountDataByHashesRespVersion}, got ${cGetAccountDataByHashesRespVersion + 1}`);
        });
    });
