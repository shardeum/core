import { ApoptosisProposalReq, cApoptosisProposalReqVersion, deserializeApoptosisProposalReq, serializeApoptosisProposalReq, } from '../../../../src/types/ApoptosisProposalReq';
