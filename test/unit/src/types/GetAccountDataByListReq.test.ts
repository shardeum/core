...
import { cGetAccountDataByListReqVersion, deserializeGetAccountDataByListReq, serializeGetAccountDataByListReq, } from '../../../../src/types/GetAccountDataByListReq';
...
describe('GetAccountDataByListReq Tests', () => {
    ...
    describe('Deserialization Tests', () => {
        ...
        test('Version mismatch error', () => {
            const stream = new VectorBufferStream(0);
            stream.writeUInt8(cGetAccountDataByListReqVersion + 1);
            stream.position = 0;
