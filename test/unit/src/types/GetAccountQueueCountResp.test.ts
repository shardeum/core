...
import { GetAccountQueueCountResp, cGetAccountQueueCountRespVersion, deserializeGetAccountQueueCountResp, serializeGetAccountQueueCountResp, } from '../../../../src/types/GetAccountQueueCountResp';
...
describe('serializeGetAccountQueueCountResp', () => {
    test('should serialize with root = true', () => {
        ...
        expectedStream.writeUInt16(TypeIdentifierEnum.cGetAccountQueueCountResp);
...
describe('deserializeGetAccountQueueCountResp', () => {
    ...
    test('should throw error with version mismatch', () => {
        ...
        expect(() => deserializeGetAccountQueueCountResp(alteredStream)).toThrow('GetAccountQueueCountResp version mismatch');
    });
