...
import { GetAccountDataByHashesReq, cGetAccountDataByHashesReqVersion, deserializeGetAccountDataByHashesReq, serializeGetAccountDataByHashesReq, } from '../../../../src/types/GetAccountDataByHashesReq';
...
describe('GetAccountDataByHashesReq Tests', () => {
    ...
    describe('Serialization Tests', () => {
        ...
        test('Version Mismatch Error', () => {
            ...
            buffer[0] = cGetAccountDataByHashesReqVersion + 1;
            stream.position = 0;
            expect(() => deserializeGetAccountDataByHashesReq(stream)).toThrow(`GetAccountDataByHashesReqDeserializer expected version ${cGetAccountDataByHashesReqVersion}, got ${cGetAccountDataByHashesReqVersion + 1}`);
        });
    });
