...
import { GetAccountDataByListResp, cGetAccountDataByListRespVersion, deserializeGetAccountDataByListResp, serializeGetAccountDataByListResp, } from '../../../../src/types/GetAccountDataByListResp';
...
describe('GetAccountDataByListResp Serialization and Deserialization', () => {
    ...
    describe('Serialization', () => {
        describe('Valid Data Cases', () => {
            test('should serialize non-null accountData correctly with root true', () => {
                ...
                expectedStream.writeUInt8(cGetAccountDataByListRespVersion);
    ...
    describe('Deserialization', () => {
        ...
        test('should throw version mismatch error', () => {
            const stream = new VectorBufferStream(0);
            stream.writeUInt8(cGetAccountDataByListRespVersion + 1);
            stream.position = 0;
