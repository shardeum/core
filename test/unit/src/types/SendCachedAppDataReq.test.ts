...
import { deserializeSendCachedAppDataReq, SendCachedAppDataReq, serializeSendCachedAppDataReq, } from '../../../../src/types/SendCachedAppDataReq';
...
describe('SendCachedAppDataReq Serialization and Deserialization', () => {
    ...
    describe('serializeSendCachedAppDataReq Serialization', () => {
        test('should serialize with root true', () => {
            ...
            expectedStream.writeBuffer(stateManager.app.binarySerializeObject(AppObjEnum.CachedAppData, obj.cachedAppData.appData));
    ...
    describe('deserializeSendCachedAppDataReq Deserialization', () => {
        test('should deserialize', () => {
            ...
            stream.writeBuffer(stateManager.app.binarySerializeObject(AppObjEnum.CachedAppData, obj.cachedAppData.appData));
