...
import { GetTrieAccountHashesResp, cGetTrieAccountHashesRespVersion, deserializeGetTrieAccountHashesResp, serializeGetTrieAccountHashesResp, } from '../../../../src/types/GetTrieAccountHashesResp';
...
describe('GetTrieAccountHashesResp Tests', () => {
    ...
    describe('Deserialization Tests', () => {
        ...
        test('Throw Error on Unsupported Version', () => {
            ...
            stream.position = 0;
            expect(() => deserializeGetTrieAccountHashesResp(stream)).toThrow(`Unsupported version for GetAccountTrieHashesResp: ${cGetTrieAccountHashesRespVersion + 1}`);
        });
    });
