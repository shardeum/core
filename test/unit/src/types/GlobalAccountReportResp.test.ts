...
import { serializeGlobalAccountReportResp, deserializeGlobalAccountReportResp, GlobalAccountReportRespSerializable, } from '../../../../src/types/GlobalAccountReportResp';
...
describe('GlobalAccountReportResp Tests', () => {
    ...
    test('Deserialize with version mismatch', () => {
        ...
        stream.writeUInt8(2);
        stream.position = 0;
        expect(() => deserializeGlobalAccountReportResp(stream)).toThrow('GlobalAccountReportRespSerializable version mismatch');
    });
