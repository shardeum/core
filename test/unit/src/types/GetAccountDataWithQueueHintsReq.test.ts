...
import { GetAccountDataWithQueueHintsReqSerializable, serializeGetAccountDataWithQueueHintsReq, deserializeGetAccountDataWithQueueHintsReq, } from '../../../../src/types/GetAccountDataWithQueueHintsReq';
...
describe('GetAccountDataWithQueueHintsReq Serialization and Deserialization', () => {
    ...
    describe('Deserialization', () => {
        ...
        test('should throw a version mismatch error if the version number does not match', () => {
            ...
            stream.writeString('id3');
            stream.position = 0;
            expect(() => deserializeGetAccountDataWithQueueHintsReq(stream)).toThrow('GetAccountDataWithQueueHintsReq version mismatch');
        });
