...
import { GetTrieAccountHashesReq, serializeGetTrieAccountHashesReq, deserializeGetTrieAccountHashesReq, } from '../../../../src/types/GetTrieAccountHashesReq';
...
describe('GetTrieAccountHashesReq Tests', () => {
    ...
    describe('Deserialization Tests', () => {
        ...
        test('Throw error on unsupported version', () => {
            ...
            stream.writeString('abc123,def456');
            stream.position = 0;
            expect(() => deserializeGetTrieAccountHashesReq(stream)).toThrow('Unsupported version for GetAccountTrieHashesReq: 2');
        });
    });
});