...
export const GetAccountDataInternalApiTest = async (from: ShardusTypes.Node, to: ShardusTypes.Node): Promise<void> => {
    try {
        ...
        const resp = await Comms.askBinary<GetAccountDataReqSerializable, GetAccountDataRespSerializable>(to, InternalRouteEnum.binary_get_account_data, message, serializeGetAccountDataReq, deserializeGetAccountDataResp, {
            sender_id: from.id,
        }, '0x546567890ab');
