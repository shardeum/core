...
export function serializeGetAccountDataWithQueueHintsReq(stream: VectorBufferStream, obj: GetAccountDataWithQueueHintsReqSerializable, root = false): void {
    if (root) {
...
export function deserializeGetAccountDataWithQueueHintsReq(stream: VectorBufferStream): GetAccountDataWithQueueHintsReqSerializable {
