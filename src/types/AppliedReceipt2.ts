...
import { ConfirmOrChallengeMessageSerializable, deserializeConfirmOrChallengeMessage, serializeConfirmOrChallengeMessage, } from './ConfirmOrChallengeMessage';
...
export type AppliedReceipt2Serializable = {
    ...
    signatures: SignSerializable[];
    app_data_hash: string;
};
export function serializeAppliedReceipt2(stream: VectorBufferStream, obj: AppliedReceipt2Serializable, root = false): void {
    if (root) {
