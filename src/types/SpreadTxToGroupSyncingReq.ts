...
import { AppObjEnum, OpaqueTransaction, ShardusMemoryPatternsInput, TransactionKeys, TimestampedTx, } from '../shardus/shardus-types';
...
export function serializeSpreadTxToGroupSyncingReq(stream: VectorBufferStream, inp: SpreadTxToGroupSyncingReq, root = false): void {
    if (root) {
