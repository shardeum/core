...
export const replacer = <T>(_key, value: T): {
    dataType: 'stringifyReduce_map_2_array';
    value: [
        symbol,
        unknown
...
export const reviver = <T, K, V>(_key, value: {
    dataType: 'stringifyReduce_map_2_array';
    value: [
        K,
        V
...
export const reviverExpander = <T, K, V>(_key, value: {
    dataType: 'stringifyReduce_map_2_array';
    value: [
        K,
        V
...
export const reviverMemoize = <T, K, V>(_key, value: {
    dataType: 'stringifyReduce_map_2_array';
    value: [
        K,
        V
...
export const debugReplacer = <T>(key: string, value: T): {
    dataType: 'stringifyReduce_map_2_array';
    value: [
        symbol,
        unknown
    ][];
} | Record<string, never> | string | T => {
    const originalObject = value;
...
export const debugReviver = <T, K, V>(_key, value: {
    dataType: 'stringifyReduce_map_2_array';
    value: [
        K,
        V
