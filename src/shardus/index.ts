...
*/
  ...
  _getApplicationInterface(application: ShardusTypes.App): ShardusTypes.App {
    ...
    try {
      ...
      if (typeof application.getNetworkAccountFromArchiver === 'function') {
        ...
        applicationInterfaceImpl.getNetworkAccountFromArchiver = async () => { return null }
      }
  ...
  async updateConfigChangeQueue(account: ShardusTypes.WrappedData, lastCycle_counter: number, updateNetworkAccount: boolean) {
